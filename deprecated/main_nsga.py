...
for filename in sorted(os.listdir(DATA_DIR))[0:1]:
    ...
    if filename.endswith(".json"):
        ...
        final_front, pareto_history = nsga.run(debug=True)
        ...
        # print NSGA-II completed for each instance
        #print(f"NSGA-II completed for {filename}.")
